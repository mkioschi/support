...
class PhoneNumber
{
    ...
    protected function __construct(string $value)
    {
        ...
        $this->countryCode = StrUtil::extractNumbers(array_shift($valueExploded));
        $this->areaCode = StrUtil::extractNumbers(array_shift($valueExploded));
        $this->localNumber = StrUtil::extractNumbers(join($valueExploded));
    ...
    public static function isValid(string $value): bool
    {
        ...
        $countryCode = StrUtil::extractNumbers(array_shift($valueExploded));
        $areaCode = StrUtil::extractNumbers(array_shift($valueExploded));
        $localNumber = StrUtil::extractNumbers(join($valueExploded));
