...
namespace Mkioschi\Support\Types\UnitOfMeasurement;

use Mkioschi\Support\Enums\Locale;
use Exception;
use Mkioschi\Support\Utils\NumberUtil;
...
abstract class UnitOfMeasurement
{
    ...
    ): string
    {
        ...
        $handledValue = (float)NumberUtil::numberFormat($value, $maxDecimalPlaces);
